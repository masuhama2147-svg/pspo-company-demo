...
export const PSPO_FACTS = {
  ...
  stores: GEO_STORES.length,     // 単一真実源＝地図ピンの実数(=81：愛媛77＋愛知3＋北海道1)。公式PRマイルストーンは別途 storesNote「80店舗を突破」
  storesNote: "2026/6 P・SPO夏目店で多業態80店舗を突破（旧ジムのリブランド買収＋多業態同時出店で量産）",
  ...
  newVentures: [
    "P・SPO夏目店（旧HERO KING GYM をリブランド・2026/6／80店舗を突破）",
...
export const MOAT_POINTS = [
  ...
  "会員約1.6万人＋80店舗超の多業態来館で、松山の生活者の暮らしに広く接点。自治体・県が国勢調査やアンケートでは取れない粒度・頻度。",
...
export const CIVIC_APPS = [
  { app: "リアルタイム市民行動パネル", who: "松山市・愛媛県・地元企業", why: "約1.6万人の生活者へ即日アンケート＋行動データ。年単位・低頻度・想起バイアスの公的調査を、連続・行動ベースで補完（EBPM）。", trust: "本人同意・匿名集計・オプトアウトを前提" },
...
export const LIMITS = [
  "代表性: 会員約1.6万人は松山市民の数%。運動・自己投資に積極的／有料サブスクを払える層に偏る。“代表”ではなく“補完”。国勢調査の代替ではない。",
